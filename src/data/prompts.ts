import type { CardSize, PromptItem } from "./types";

/**
 * Kích thước card trong lưới masonry — phân bố lộn xộn kiểu Pinterest.
 * Vài "xl" làm điểm nhấn, xen "sm" cho nhịp không đều.
 */
const SIZE_MAP: Record<string, CardSize> = {
  "lw-vong-quay": "xl",
  "lw-duoi-hinh": "md",
  "lw-quang-hop": "lg",
  "lw-dong-thoi-gian": "md",
  "lw-quiz-dau-truong": "xl",
  "lw-flashcard": "sm",
  "lw-trien-lam": "lg",
  "lw-nhap-vai": "md",
  "au-podcast-chuong": "md",
  "au-hoi-thoai-ta": "sm",
  "au-ke-chuyen-th": "lg",
  "vi-kich-ban-3p": "lg",
  "vi-thi-nghiem-ao": "xl",
  "im-infographic-quy-trinh": "md",
  "im-tranh-lich-su": "sm",
  "im-so-do-tu-duy": "lg",
  "sc-goi-bai-hoc": "md",
  "sc-xapi-tracking": "sm",
  "in-mo-phong-phan-so": "lg",
  "in-keo-tha-tu-loai": "md",
  "do-phieu-hoc-tap": "sm",
  "do-giao-an-5512": "md",
  "do-de-cuong-on": "sm",
  "le-slide-outline": "md",
  "le-bai-giang-tuong-tac": "lg",
  "3d-he-mat-troi": "xl",
  "3d-te-bao": "lg",
  "ex-ma-tran-de": "md",
  "ex-de-15-phut": "sm",
  "ex-cau-hoi-phan-hoa": "md",
};

/**
 * 30 prompt mẫu — 8 template bài học HTML + 22 prompt học liệu.
 * Nội dung viết thật, dùng được ngay; free = 21, premium = 9.
 * demoUrl + size được gắn tự động ở cuối file.
 */
const RAW: Omit<PromptItem, "demoUrl" | "size">[] = [
...
/** Gắn demoUrl (theo id) + size (từ SIZE_MAP) cho mọi item */
export const PROMPTS: PromptItem[] = RAW.map((raw) => ({
  ...raw,
  demoUrl: `/demos/${raw.id}.html`,
  size: SIZE_MAP[raw.id] ?? "md",
}));
